...
"button_labels": {
    ...
    "greeting": {
        "en": "Hello, I'm Rhonda. I can help you find housing, food, legal aid, and more in Richmond. Everything you share is strictly anonymous. Select a topic below or just tell me what you need.",
        "es": "Hola, soy Rhonda. Puedo ayudarte a encontrar vivienda, comida, asistencia legal y más en Richmond. Todo lo que compartas es estrictamente anónimo. Selecciona un tema a continuación o dime qué necesitas.",
        "ar": "مرحباً، أنا روندا. يمكنني مساعدتك في العثور على سكن، طعام، مساعدة قانونية والمزيد في ريتشموند. كل ما تشاركه مجهول تماماً. اختر موضوعاً أدناه أو أخبرني بما تحتاجه.",
        "fa": "سلام، من روندا هستم. می توانم به شما در یافتن مسکن، غذا، کمک حقوقی و موارد دیگر در ریچموند کمک کنم. همه چیزهایی که به اشتراک می گذارید کاملاً ناشناس است. موضوعی را در زیر انتخاب کنید یا فقط بگویید به چه چیزی نیاز دارید.",
        "ps": "سلام، زه رونډا یم. زه کولی شم تاسو سره په ریچمنډ کې د کور، خواړو، قانوني مرستې او نورو موندلو کې مرسته وکړم. هرڅه چې تاسو یې شریکوئ په کلکه نامعلوم دي. لاندې یوه موضوع غوره کړئ یا یوازې ما ته ووایاست چې تاسو څه ته اړتیا لرئ.",
        "pt": "Olá, sou a Rhonda. Posso ajudá-lo a encontrar moradia, alimentação, assistência jurídica e muito mais em Richmond. Tudo o que você compartilhar é estritamente anônimo. Selecione um tópico abaixo ou apenas me diga do que você precisa.",
